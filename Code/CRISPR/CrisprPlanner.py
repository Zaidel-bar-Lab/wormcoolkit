...
class CrisprPlanner:
    ...
    def plan_my_crispr_insertion(self,
        ...
        if self.ssODN_mutation_codon_start == self.sense_mutation_site:   ## looking the sense strand
            if self.ssODN_direction == 1 and self.DSB >= self.sense_mutation_site:                     ##  the cut is right to the insertion
                print("case 4")
                HA1 = self.sense_strand[self.sense_mutation_site-35:self.sense_mutation_site]
                print('HA1',HA1)
                complete = self.sense_strand[self.sense_mutation_site:self.DSB]
                print("complete" ,complete)
                HA2 = self.sense_strand[self.DSB:self.DSB+35]
                print("HA2",HA2)
            ...
            if self.ssODN_direction == 1 and self.DSB < self.sense_mutation_site:                     ##  the cut is right to the insertion
                print("case 3")
                HA1 = self.sense_strand[self.DSB-35:self.DSB]
                print('HA1',HA1)
                complete = self.sense_strand[self.DSB:self.sense_mutation_site]
                print("complete", complete)
                HA2 = self.sense_strand[self.sense_mutation_site:self.sense_mutation_site+35]
                print("HA2",HA2)
        ...
        if self.ssODN_mutation_codon_start == self.anti_sense_mutation_site:   ## looking the anti-sense strand
            if self.ssODN_direction == -1 and self.DSB >= self.anti_sense_mutation_site+3:                     ##  the cut is right to the insertion
                print("case 1")
                case = 1
                HA1 = self.anti_sense_strand[self.DSB:self.DSB+35]
                print('HA1',HA1)
                complete = self.anti_sense_strand[self.anti_sense_mutation_site:self.DSB]
                print("complete:",complete)
            ...
            if self.ssODN_direction == -1 and self.DSB < self.anti_sense_mutation_site+3:                     ##  the cut is right to the insertion
                print("case 2")
                HA1 = self.anti_sense_strand[self.anti_sense_mutation_site+3:self.anti_sense_mutation_site+3+35]
                print('HA1',HA1)
                complete = self.anti_sense_strand[self.DSB:self.anti_sense_mutation_site+3]
                print("complete:",complete )
                HA2 = self.anti_sense_strand[self.DSB-35:self.DSB]
                print("HA2",HA2)
